...
// Given by Instructor
template<typename BlockType> struct FFTDataGenerator {
    /**
...
// Given by Instructor
template<typename PathType> struct AnalyzerPathGenerator {
    /*
...
struct ResponseCurveComponent : public juce::AudioProcessorEditor,
